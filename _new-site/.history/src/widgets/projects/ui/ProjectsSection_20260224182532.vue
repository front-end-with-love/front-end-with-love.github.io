...
/** Projects accordion: 6 items, open/close one at a time. */
import { ref } from 'vue'
...
<template>
  <section id="projects" class="projects">
    <div class="projects__header reveal-trigger">
      <span class="projects__num reveal-text">[02] — SELECTED WORKS</span>
      <h2 class="projects__title"><span class="reveal-text delay-100">Projects</span></h2>
      <p class="projects__meta"><span class="reveal-text delay-300 block">SPA · Landing · E-com · Web3 · AI<br />Tver → Worldwide</span></p>
    </div>
      ...
      >
        ...
        <div class="projects__body" :style="{ maxHeight: openIndex === i ? '1200px' : '0' }">
          <div class="projects__body-inner">
            <div class="projects__body-spacer" />
            <div class="projects__body-left">
              ...
              <ul class="projects__bullets">
                <li v-for="(b, bi) in p.bullets" :key="bi" class="projects__bullet">
                  <span class="projects__bullet-arrow">→</span>
                  {{ b }}
                </li>
              </ul>
            </div>
