...
<template>
  <section id="projects" class="projects">
    <div class="projects__header reveal-trigger">
      ...
      <p class="projects__meta"><span class="reveal-text delay-300 block">Layout &middot; JS &middot; Scripts &middot; Interaction scenarios<br />SPA &middot; Landing &middot; E-com &middot; Web3 &middot; AI · Russia &rarr; Worldwide</span></p>
    </div>
